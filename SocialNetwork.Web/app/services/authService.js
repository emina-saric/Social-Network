...
app.factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', function ($http, $q, localStorageService, ngAuthSettings) {
    ...
    var _obtainAccessToken = function (externalData) {
        ...
        $http.get("http://localhost:57409/" + 'api/account/ObtainLocalAccessToken', { params: { provider: externalData.provider, externalAccessToken: externalData.externalAccessToken } }).success(function (response) {
    ...
    var _registerExternal = function (registerExternalData) {
        ...
        $http.post("http://localhost:57409/" + 'api/account/registerexternal', registerExternalData).success(function (response) {
